...
| 10:30 | _Investigating Linguistic Abilities of LLMs for Native Language Identification_ |  Ahmet Yavuz Uluslu and Gerold Schneider |
| 11:00 | _PIRLS Category-specific Question Generation for Reading Comprehension_ |  Yin Poon, Qiong Wang, John S. Y. Lee, Yu Yan Lam, and Samuel Kai Wah Chu |
| 11:30 | _Interpretable Machine Learning for Societal Language Identification: Modeling English and German Influences on Portuguese Heritage Language_ |  Soroosh Akef, Detmar Meurers, Amália Mendes, and Patrick Rebuschat |
| 12:00 | _**Break**_ | |
| | _**Session 3: Demos and Work in Progress**_ | *Chair: Ricardo Muñoz Sánchez* |
| 12:15 | _A prototype authoring tool for editing authentic texts using LLMs to increase support for contextualised L2 grammar practice_ | Stephen Bodnar |
...
| 15:30 | _The MultiGEC-2025 Shared Task on Multilingual Grammatical Error Correction at NLP4CALL_ |  Arianna Masciolini, Andrew Caines, Orphée De Clercq, Joni Kruijsbergen, Murathan Kurfalı, Ricardo Muñoz Sánchez, Elena Volodina, and Robert Östling |
| 16:00 | _Lattice @MultiGEC-2025: A Spitful Multilingual Language Error Correction System Using LLaMA_ |  Olga Seminck, Yoann Dupont, Mathieu Dehouck, Qi Wang, Noé Durandard, and Margo Novikov |
| 16:30 | _UAM-CSI at MultiGEC-2025: Parameter-efficient LLM Fine-tuning for Multilingual Grammatical Error Correction_ | Ryzard Staruch |
